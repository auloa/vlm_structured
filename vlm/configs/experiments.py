...
def donut_tinyllama() -> ExperimentConfig:
...
def finetuned_donut_real() -> ExperimentConfig:
    cfg = ExperimentConfig(name="finetuned-donut-real")
...
EXPERIMENTS = {
    ...
    "finetuned-donut-real": finetuned_donut_real,
}
